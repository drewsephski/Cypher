    ...
    <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
      ...
      <div className="relative flex h-full w-full items-center justify-center overflow-hidden">
        <div className="relative flex h-full w-full items-center justify-center translate-y-0 md:translate-y-32">
          ...
          {/* Inner Ring - 6 icons evenly spaced */}
          <OrbitingCircles
            index={0}
            iconSize={60}
            radius={120}
            reverse
            speed={1}
            centerIcon={<Router className="size-10 text-orange-600 bg-orange-200" />}
            centerIconSize={80}
          ...
          {/* Middle Ring - 8 icons evenly spaced */}
          <OrbitingCircles index={1} iconSize={60} radius={200} speed={0.5} centerIcon={<Code className="size-10 text-secondary" />} centerIconSize={80} startAnimationDelay={0.1} once={true}>
          ...
          {/* Outer Ring - 10 icons evenly spaced */}
          <OrbitingCircles
            index={2}
            iconSize={60}
            radius={280}
          ...
          >
            ...
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-2xl border-2 border-gray-300 hover:border-accent/60 transition-all duration-300 hover:scale-110 hover:shadow-3xl">
              <Wifi className="size-8 text-accent" />
            </div>
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-2xl border-2 border-gray-300 hover:border-accent/60 transition-all duration-300 hover:scale-110 hover:shadow-3xl">
          ...
          {/* Fourth outer ring - 10 icons evenly spaced */}
          <OrbitingCircles
            index={3}
            iconSize={60}
            radius={380}
            ...
            once={true}
          >
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-xl border-2 border-gray-300 hover:border-muted/60 transition-all duration-300 hover:scale-110 hover:shadow-2xl">
              <Terminal className="size-8 text-muted" />
            </div>
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-xl border-2 border-gray-300 hover:border-muted/60 transition-all duration-300 hover:scale-110 hover:shadow-2xl">
              <Github className="size-8 text-muted" />
            </div>
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-xl border-2 border-gray-300 hover:border-muted/60 transition-all duration-300 hover:scale-110 hover:shadow-2xl">
              <Cloud className="size-8 text-muted" />
            </div>
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-xl border-2 border-gray-300 hover:border-muted/60 transition-all duration-300 hover:scale-110 hover:shadow-2xl">
              <Server className="size-8 text-muted" />
            </div>
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-xl border-2 border-gray-300 hover:border-muted/60 transition-all duration-300 hover:scale-110 hover:shadow-2xl">
              <Router className="size-8 text-muted" />
            </div>
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-xl border-2 border-gray-300 hover:border-muted/60 transition-all duration-300 hover:scale-110 hover:shadow-2xl">
            ...
            <div className="size-12 bg-white rounded-full flex items-center justify-center shadow-xl border-2 border-gray-300 hover:border-muted/60 transition-all duration-300 hover:scale-110 hover:shadow-2xl">
              <Code className="size-8 text-muted" />
            </div>
          </OrbitingCircles>
        </div>
      </div>
      ...
      <div className="absolute top-22 left-32 opacity-90 hover:opacity-100 transition-opacity">
      ...
      <div className="absolute top-1/3 right-24 opacity-65 hover:opacity-85 transition-opacity">
      ...
      <div className="absolute top-22 right-38 opacity-60 hover:opacity-80 transition-opacity">
      ...
      <div className="absolute bottom-28 left-26 opacity-60 hover:opacity-80 transition-opacity">
        <div className="size-4 bg-rose-500/15 rounded-full flex items-center justify-center border border-rose-500/25 hover:bg-rose-500/25 hover:scale-110 hover:shadow-sm transition-all duration-300">
          <Terminal className="size-3 text-rose-600" />
        </div>
      </div>

      <div className="absolute bottom-32 right-36 opacity-60 hover:opacity-80 transition-opacity">
        <div className="size-4 bg-blue-500/15 rounded-full flex items-center justify-center border border-blue-500/25 hover:bg-blue-500/25 hover:scale-110 hover:shadow-sm transition-all duration-300">
          <Router className="size-3 text-blue-600" />
        </div>
      </div>
    </div>
  );
